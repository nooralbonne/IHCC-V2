...
/**
 * Footer — closes out the page after Contact.
 * Same fonts / palette / iconography as the rest of the site, with a
 * simple fade-up reveal (footers don't need the staggered treatment
 * used higher up the page, just a quiet entrance).
 */
